...
#define muic_err(fmt, ...)	pr_err(pr_fmt(fmt), ##__VA_ARGS__);
#define muic_info(fmt, ...)	pr_info(pr_fmt(fmt), ##__VA_ARGS__);
#define muic_dbg(fmt, ...)	pr_debug(pr_fmt(fmt), ##__VA_ARGS__);
