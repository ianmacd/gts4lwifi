...
#define SEC_TS_DEFAULT_FW_NAME		"tsp_sec/sec_veyron.fw"
...
#define SEC_TS_FW_UPDATE_ON_PROBE	1
#undef CALIBRATION_BY_FACTORY	/* TSP CAL in SEC Factory Line */
#define CALIBRATION_BY_SDC		/* TSP CAL in SDC Factory Line*/
...
#define SEC_TS_WAIT_RETRY_CNT		5
