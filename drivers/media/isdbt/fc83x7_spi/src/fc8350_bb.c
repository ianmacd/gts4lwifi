...
s32 fc8350_init(HANDLE handle, DEVICEID devid)
{
	...
	bbm_byte_write(handle, DIV_BROADCAST, BBM_MEMORY_RWM8350_0, 0x77);
	bbm_byte_write(handle, DIV_BROADCAST, BBM_MEMORY_RWM8350_1, 0x77);
	bbm_byte_write(handle, DIV_BROADCAST, BBM_MEMORY_RWM8350_2, 0x77);
