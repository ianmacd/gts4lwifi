...
static s32 fc8300_set_tsif_clk(HANDLE handle, DEVICEID devid)
{
	...
	if (BBM_XTAL_FREQ == 16000)
		...
		, BBM_PLL2_PRE_POST_SELECTION, 0x1621);
	else if (BBM_XTAL_FREQ == 16384)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1521);
	else if (BBM_XTAL_FREQ == 18000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1321);
	else if (BBM_XTAL_FREQ == 19200)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1221);
	else if (BBM_XTAL_FREQ == 24000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1e22);
	else if (BBM_XTAL_FREQ == 24576)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1d22);
	else if (BBM_XTAL_FREQ == 26000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1c22);
	else if (BBM_XTAL_FREQ == 27000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1b22);
	else if (BBM_XTAL_FREQ == 27120)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1a22);
	else if (BBM_XTAL_FREQ == 32000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1622);
	else if (BBM_XTAL_FREQ == 37200)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1322);
	else if (BBM_XTAL_FREQ == 37400)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1322);
	else if (BBM_XTAL_FREQ == 38400)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1222);
#elif (BBM_TSIF_CLK == 32000)
	if (BBM_XTAL_FREQ == 16000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0e21);
	else if (BBM_XTAL_FREQ == 16384)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0e21);
	else if (BBM_XTAL_FREQ == 18000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0c21);
	else if (BBM_XTAL_FREQ == 19200)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0b21);
	else if (BBM_XTAL_FREQ == 24000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1322);
	else if (BBM_XTAL_FREQ == 24576)
		...
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1122);
	else if (BBM_XTAL_FREQ == 27120)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x1122);
	else if (BBM_XTAL_FREQ == 32000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0e22);
	else if (BBM_XTAL_FREQ == 37200)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0c22);
	else if (BBM_XTAL_FREQ == 37400)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0c22);
	else if (BBM_XTAL_FREQ == 38400)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0b22);
	...
	if (BBM_XTAL_FREQ == 16000)
		...
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0921);
	else if (BBM_XTAL_FREQ == 19200)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0921);
	else if (BBM_XTAL_FREQ == 24000)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0f22);
	else if (BBM_XTAL_FREQ == 24576)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0f22);
	else if (BBM_XTAL_FREQ == 26000)
		...
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0d22);
	else if (BBM_XTAL_FREQ == 27120)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0d22);
	else if (BBM_XTAL_FREQ == 32000)
		...
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0922);
	else if (BBM_XTAL_FREQ == 37400)
		bbm_word_write(handle, devid
		, BBM_PLL2_PRE_POST_SELECTION, 0x0922);
	else if (BBM_XTAL_FREQ == 38400)
...
s32 fc8300_scan_status(HANDLE handle, DEVICEID devid)
{
	...
	u8 done = 0x0f;
#endif
	print_log(0, "ISDBT fc8300_scan_status BBM_2_DIVERSITY\n");
