...
static struct secdp_display_timing secdp_supported_resolution[] = {
	{0, 640, 480, 60, 0, DEX_FHD_SUPPORT},
	{1, 720, 480, 60, 0, DEX_FHD_SUPPORT},
	{2, 720, 576, 50, 0, DEX_FHD_SUPPORT},

	{3, 1280, 720, 50, 0, DEX_FHD_SUPPORT},
	{4, 1280, 720, 60, 0, DEX_FHD_SUPPORT},

	{5, 1280, 800, 60, 0, DEX_FHD_SUPPORT}, /* CTS 18bpp */
	{6, 1280, 1024, 60, 0, DEX_FHD_SUPPORT}, /* CTS 18bpp */

	{7, 1366, 768, 60, 0, DEX_FHD_SUPPORT},
	{8, 1600, 900, 60, 0, DEX_FHD_SUPPORT},

	{9, 1920, 1080, 24, 0, DEX_FHD_SUPPORT},
	{10, 1920, 1080, 25, 0, DEX_FHD_SUPPORT},
	{11, 1920, 1080, 30, 0, DEX_FHD_SUPPORT},
	{12, 1920, 1080, 50, 0, DEX_FHD_SUPPORT},
	{13, 1920, 1080, 60, 0, DEX_FHD_SUPPORT},

	{14, 1920, 1440, 60, 0, DEX_WQHD_SUPPORT}, /* CTS 400.3.3.1 */
	{15, 2048, 1536, 60, 0, DEX_WQHD_SUPPORT}, /* CTS 18bpp */
	{16, 2560, 1440, 60, 0, DEX_WQHD_SUPPORT},
	{17, 1440, 2560, 60, 0, DEX_NOT_SUPPORT},	/* TVR */
	{18, 1440, 2560, 75, 0, DEX_NOT_SUPPORT},	/* TVR */

	{19, 3840, 2160, 24, 0, DEX_NOT_SUPPORT},
	{20, 3840, 2160, 25, 0, DEX_NOT_SUPPORT},
	{21, 3840, 2160, 30, 0, DEX_NOT_SUPPORT},
	{22, 3840, 2160, 50, 0, DEX_NOT_SUPPORT},
	{23, 3840, 2160, 60, 0, DEX_UHD_SUPPORT},

	{24, 4096, 2160, 24, 0, DEX_NOT_SUPPORT},
	{25, 4096, 2160, 25, 0, DEX_NOT_SUPPORT},
	{26, 4096, 2160, 30, 0, DEX_NOT_SUPPORT},
	{27, 4096, 2160, 50, 0, DEX_NOT_SUPPORT},
	{28, 4096, 2160, 60, 0, DEX_UHD_SUPPORT},
};
		...
		if (support[i].active_h == info->active_h &&
			...
			if (diff < 2) {
				...
				if (secdp_check_dex_mode()) {
					if (support[i].dex_support != DEX_NOT_SUPPORT &&
						support[i].dex_support <= secdp_get_adapter_type())
						return 1;
					else
						return 0;
				}
