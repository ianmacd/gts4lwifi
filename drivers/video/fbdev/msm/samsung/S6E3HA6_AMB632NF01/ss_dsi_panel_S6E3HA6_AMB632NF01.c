...
static char mdss_panel_revision(struct mdss_dsi_ctrl_pdata *ctrl)
{
	...
	/* A3 panel - from revM */
	if (mdss_panel_id0_get(ctrl) & 0x40) {
		switch (mdss_panel_rev_get(ctrl)) {
			case 0x00:
				vdd->panel_revision = 'M';
				LCD_INFO("Panel REV.A / A3 PANEL\n");
				break;
			default:
				vdd->panel_revision = 'M';
				LCD_ERR("Invalid panel_rev(default rev : %c) / A3 PANEL\n", vdd->panel_revision);
				break;
		}
	}
...
static char irc_hbm_para_revM[8][20] = {
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x32},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x33},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x34},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x35},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x36},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x37},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x38},
	{0x61, 0xF0, 0x29, 0x26, 0x42, 0xBA, 0x33, 0x69, 0x12, 0x7A, 0xED, 0x99, 0x93, 0x96, 0x33, 0x31, 0x32, 0x33, 0x31, 0x39},
};
	...
	*level_key = LEVEL1_KEY;
	...
	switch (vdd->panel_revision) {
		...
		case 'E' ... 'L':
			...
			break;
		case 'M':
			memcpy(&hbm_irc_cmds->cmds[0].payload[1], irc_hbm_para_revM[para_idx], 20);
			break;
		default: /* Rev. M ~ */
			memcpy(&hbm_irc_cmds->cmds[0].payload[1], irc_hbm_para_revM[para_idx], 20);
			break;
